...
arm64: $(BUILD_DIR)
	...
	(echo "ARM64 native build failed - use cross-compilation tools or native ARM64 environment")
...
test:
	...
	cd golang-gui-crossbuild && go test ./...
...
deps:
	...
	cd golang-gui-crossbuild && go mod download
	cd golang-gui-crossbuild && go mod tidy
...
help:
	...
	@echo "  all        - Build for AMD64 and ARM64 native versions"
	@echo "  amd64      - Build native GUI for AMD64 (x86_64)"
	@echo "  arm64      - Build native GUI for ARM64"
